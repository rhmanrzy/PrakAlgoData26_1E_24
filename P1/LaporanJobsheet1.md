...
1. Buatlah program untuk menghitung nilai akhir dari mahasiswa dengan ketentuan 20% nilai tugas, 20% dari nilai kuis, 30% nilai UTS, dan 40% nilai UAS.
   ...
   ![img](https://github.com/user-attachments/assets/2935e575-7801-4f72-9c86-1c016f2803af)
   ...
   #### Code Program
   ![img](https://github.com/user-attachments/assets/a62d7f78-753c-4463-ade9-914b623950bf)

   #### Hasil Running
   ![img](https://github.com/user-attachments/assets/7177e8eb-c4c9-4144-8c96-908c0c24e8e6)

   ![img](https://github.com/user-attachments/assets/9e3d8399-c0bc-453d-80aa-2192c5547e4c)
...
1. Buatlah program yang dapat menampilkan deretan bilangan dari angka 1 sampai n, dengan n = 2-digit terakhir NIM Anda. Berikut adalah ketentuan untuk mencetak deretnya :
   ...
   *bila n<10 maka tambahkan 10 (n+=10)
   ...
   #### Code Program
   ![img](https://github.com/user-attachments/assets/291aa8af-23a4-42d9-8488-b69319d03581)

   #### Hasil Running
   ![img](https://github.com/user-attachments/assets/eb258745-b1f5-4aaa-bd8d-5b47147a98e2)
...
1. Buatlah program untuk menghitung IP Semester dari mata kuliah yang Anda tempuh semester lalu. Formula untuk menghitung IP semester sebagai berikut :
   ...
   ![img](https://github.com/user-attachments/assets/94611c70-37c3-4478-8f89-4d3868e022da)
   
   Nilai setara didapatkan dari tabel konversi berikut ini :
   
   ![img](https://github.com/user-attachments/assets/978d589f-036a-4998-af7a-0c72ed459952)
   
   Input dari program berupa nama mata kuliah, bobot SKS, serta nilai huruf dari mata kuliah tersebut.

   #### Code Program
   ![img](https://github.com/user-attachments/assets/c10f35c9-b9a4-4737-8228-a5faadbf5a48)

   ![img](https://github.com/user-attachments/assets/f1f8f3f7-0d02-4222-bcae-089a19ac45fa)

   #### Hasil Running
   ![img](https://github.com/user-attachments/assets/824af043-93f0-446e-bf25-f9598728f0c3)
...
1. RoyalGarden adalah toko bunga yang memiliki banyak cabang. Setiap hari Stock Bunga dan bunga-bunga yang dijual selalu dicatat dengan rincian seperti berikut ini :
   ...
   ![img](https://github.com/user-attachments/assets/bc535038-e1ac-48bd-8b7f-12441d0aa76e)
   ...
   2. Tampilkan status dari setiap cabang dengan ketentuan sebagai berikut ini :
      ...
      #### Code Program
      ![img](https://github.com/user-attachments/assets/0ba49aff-6922-422b-a395-80fc074513fd)

      #### Hasil Running
      ![img](https://github.com/user-attachments/assets/7da88d3e-1f1c-4362-ae3c-7279e1f9dde8)
...
![img](https://github.com/user-attachments/assets/78967c43-021a-4ef3-8bd6-90bcbef5ad76)

Ketika pengguna memberikan input kode plat nomor maka program akan mengeluarkan nama kota dari kode plat nomor tersebut.

#### Code Program
![img](https://github.com/user-attachments/assets/1258e262-532a-4f27-8d7a-a7361622dbc3)

#### Hasil Running
![img](https://github.com/user-attachments/assets/128bac1c-5371-41b1-91e7-590a31347ca7)
...
#### Code Program
![img](https://github.com/user-attachments/assets/1eca4a69-a81c-4b84-893f-ca028167462b)

![img](https://github.com/user-attachments/assets/a08224dc-7356-4c49-b4a3-87cb5df4662a)

#### Hasil Running
![img](https://github.com/user-attachments/assets/2671b2e7-74a7-4076-9013-a6dcf0b84654)
